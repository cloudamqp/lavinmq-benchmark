...
variable "source_repo" {
  description = "Git repository URL to clone and build lavinmqperf from. Empty = use apt-installed binary."
  type        = string
  default     = ""
}

variable "source_ref" {
  description = "Git ref (branch or commit hash) to check out when building lavinmqperf from source."
  type        = string
  default     = ""
}
