...
variable "rate_limits" {
  description = "List of rate limits (msgs/s) to test for latency measurement"
  type        = list(number)
  default     = [10, 100, 1000, 10000, 50000, 100000, 200000, 500000]
}

variable "test_duration" {
  description = "Duration of each test in seconds (lavinmqperf -z flag)"
  type        = number
  default     = 120
}
