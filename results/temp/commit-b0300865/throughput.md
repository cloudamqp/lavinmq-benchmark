...
Benchmark results for AWS instance types with LavinMQ version vcommit-b0300865.

```shell
lavinmqperf throughput -z 20 -x 1 -y 1 -s <size>
```
...
|------:|------------------:|------------------:|------------:|------------:|
|    16 |           950,943 |           950,220 |       14.51 |       14.49 |
|    64 |           896,106 |           895,652 |       54.69 |       54.66 |
